...
const ezobjectTypes = [
  ...
  { type: `date`, jsType: `Date`, mysqlType: `date`, default: new Date(0), saveTransform: x => moment(x).format(`YYYY-MM-DD`), loadTransform: x => new Date().setUTCDate(x), setTransform: setTransform },
  { type: `time`, jsType: `string`, mysqlType: `time`, default: `00:00:00`, setTransform: setTransform },
  { type: `timestamp`, jsType: `Date`, mysqlType: `timestamp`, default: new Date(0), setTransform: setTransform, saveTransform: x => moment(x).format(`YYYY-MM-DD HH:mm:ss.SSSSSS`), loadTransform: x => new Date().setUTCDate(x) },
  { type: `datetime`, jsType: `Date`, mysqlType: `datetime`, default: new Date(0), setTransform: setTransform, saveTransform: x => moment(x).format(`YYYY-MM-DD HH:mm:ss.SSSSSS`), loadTransform: x => new Date().setUTCDate(x) },
  ...
  { type: `array`, jsType: `Array`, mysqlType: `text`, default: [], arrayOfType: `date`, setTransform: setArrayTransform, saveTransform: x => x.map(y => moment(y).format(`YYYY-MM-DD`)).join(`,`), loadTransform: x => x === `` ? [] : x.split(`,`).map(y => new Date().setUTCDate(y)) },
  ...
  { type: `array`, jsType: `Array`, mysqlType: `text`, default: [], arrayOfType: `timestamp`, setTransform: setArrayTransform, saveTransform: x => x.map(y => moment(y).format(`YYYY-MM-DD HH:mm:ss.SSSSSS`)).join(`,`), loadTransform: x => x === `` ? [] : x.split(`,`).map(y => new Date().setUTCDate(y)) },
  { type: `array`, jsType: `Array`, mysqlType: `text`, default: [], arrayOfType: `datetime`, setTransform: setArrayTransform, saveTransform: x => x.map(y => moment(y).format(`YYYY-MM-DD HH:mm:ss.SSSSSS`)).join(`,`), loadTransform: x => x === `` ? [] : x.split(`,`).map(y => new Date().setUTCDate(y)) },
