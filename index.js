...
const ezobjectTypes = [
  ...
  { type: `date`, jsType: `Date`, mysqlType: `date`, default: new Date(0), saveTransform: x => moment(x).utc().format(`YYYY-MM-DD`), loadTransform: x => x ? new Date(x) : null, setTransform: setTransform },
  { type: `time`, jsType: `string`, mysqlType: `time`, default: `00:00:00`, setTransform: setTransform },
  { type: `timestamp`, jsType: `Date`, mysqlType: `timestamp`, default: new Date(0), setTransform: setTransform, saveTransform: x => moment(x).utc().format(`YYYY-MM-DD HH:mm:ss.SSSSSS`), loadTransform: x => x ? new Date(x) : null },
  { type: `datetime`, jsType: `Date`, mysqlType: `datetime`, default: new Date(0), setTransform: setTransform, saveTransform: x => moment(x).utc().format(`YYYY-MM-DD HH:mm:ss.SSSSSS`), loadTransform: x => x ? new Date(x) : null },
  ...
  { type: `array`, jsType: `Array`, mysqlType: `text`, default: [], arrayOfType: `date`, setTransform: setArrayTransform, saveTransform: x => x.map(y => moment(y).utc().format(`YYYY-MM-DD`)).join(`,`), loadTransform: x => x === `` ? [] : x.split(`,`).map(y => y ? new Date(y) : null) },
  ...
  { type: `array`, jsType: `Array`, mysqlType: `text`, default: [], arrayOfType: `timestamp`, setTransform: setArrayTransform, saveTransform: x => x.map(y => moment(y).utc().format(`YYYY-MM-DD HH:mm:ss.SSSSSS`)).join(`,`), loadTransform: x => x === `` ? [] : x.split(`,`).map(y => y ? new Date(y) : null) },
  { type: `array`, jsType: `Array`, mysqlType: `text`, default: [], arrayOfType: `datetime`, setTransform: setArrayTransform, saveTransform: x => x.map(y => moment(y).utc().format(`YYYY-MM-DD HH:mm:ss.SSSSSS`)).join(`,`), loadTransform: x => x === `` ? [] : x.split(`,`).map(y => y ? new Date(y) : null) },
